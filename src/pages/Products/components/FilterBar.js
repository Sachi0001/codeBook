                  ...
                  <ul className="text-slate-700 dark:text-slate-100">
                    ...
                    <li className="mt-1 mb-5">
                      ...
                      <div className="flex items-center my-1">
                          ...
                          })} checked={state.rating==="4STARS ABOVE"}
                      ...
                      <div className="flex items-center my-1">
                          ...
                          })} checked={state.rating==="3STARS ABOVE"}
                      ...
                      <div className="flex items-center my-1">
                          ...
                          })} checked={state.rating==="2STARS ABOVE"}
                      ...
                      <div className="flex items-center my-1">
                          ...
                          })} checked={state.rating==="1STAR ABOVE"}
                    ...
                    <li className="mt-1 mb-5">
                      ...
                      <div className="flex items-center my-1">
                          ...
                          })} checked={state.inStockOnly || false} id="only-instock" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600" />
